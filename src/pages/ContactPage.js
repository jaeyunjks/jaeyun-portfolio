...
export default function ContactPage() {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
            .sendForm(
                "service_jkgvb2e",           // Your EmailJS Service ID
                "template_hm943z9",           // Your Template ID from EmailJS
                form.current,                // Form reference
                { publicKey: "cfBYxuTPnUhXt9G1j" } // Your Public Key
            )
            .then(
                () => {
        ...
        >
            ...
            <div style={{ fontSize: 20, fontWeight: 700, margin: 20 }}>
                <a
                    ...
                    style={{ color: "#7B9ACC", marginRight: 28, textDecoration: "none" }}
                >
                    LinkedIn
                </a>
                <a
                    href="mailto:yaafiiee.10@gmail.com"
                    style={{ color: "#7B9ACC", textDecoration: "none" }}
                >
